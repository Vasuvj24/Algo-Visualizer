...
while (start <= end) {
    ...
    output.style="text-shadow: 0 0 10px Green,0 0 20px Green, 0 0 40px Green;"
	...
	blocks[mid].style.backgroundColor = "cyan";
	} else {
	start = mid + 1;
	blocks[mid].style.backgroundColor = "cyan";
	}
...
if (flag === 0) {
    ...
    output.style="text-shadow: 0 0 10px Red,0 0 20px Red, 0 0 40px Red";
}
}	
generatearray();
